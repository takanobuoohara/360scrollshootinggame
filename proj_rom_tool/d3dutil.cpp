...
// Desc: Helper function called to initialize a D3DDEVICEDESC7 structure,
//-----------------------------------------------------------------------------
VOID D3DUtil_InitDeviceDesc( D3DDEVICEDESC7& ddDevDesc )
{
    ZeroMemory( &ddDevDesc, sizeof(D3DDEVICEDESC7) );
//    ddDevDesc.dwSize                  = sizeof(D3DDEVICEDESC7);
